...
const { id } = useParams(); 
  ...
  return (
    ...
    <div className="single_product">
      ...
      {/* <Box sx={{ flexGrow: 2 }} className='product_box'>
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, md: 6 }}>
          <Item className='hero_img' id='hero_img3'>
            <img src={myproduct.imgUrl} alt={myproduct.name} />
          </Item>
        </Grid>
        <Grid size={{ xs: 12, md: 6 }}>
          <Item className='product_details mt-4' id='product_details3'>
            <h1>{myproduct.productName}</h1>
            <Box
              className="rating-box2 mt-4"
              id="rating-box2"
            ...
            >
              ...
              />
              <label className='ps-3 rating_label'>{myproduct.reviews[0].rating}</label>
            ...
            <h4 className="product-price">${myproduct.price}</h4>
            <p>{myproduct.description}</p>
            <input type="text" placeholder='1'  className='quntity_input'/>
    ...
    <div class="container1 text-center m-5">
      <div class="row ">
        <div class="col-sm-6 img_box ">
          <img className='product_img' src={myproduct.imgUrl} alt={myproduct.name} />
        </div>
      ...
      <div class="row">
        <div class="col-sm text-md-start mt-5">
          <h3 className='mt-5 product_details'>Product Details <span className='reviews_count'>Reviews ({myproduct.reviews.length})</span> </h3>
