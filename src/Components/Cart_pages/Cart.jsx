    ...
    <div>
      {cartData.length > 0 ? (
            ...
            <div className="container atc_container" key={product.id}>
              <div className="row">
                <div className="col-md-3">
                  <Card
                    className="cart-card"
                    style={{ width: "44rem", height: "14rem" }}
                  >
                    <Card.Img
                      style={{
                        width: "16rem",
                    ...
                    <Card.Body>
                      <Card.Text className="cart-quantity ms-4">
                        Quantity: {product.quantity}
                      </Card.Text>
                      <Card.Text className="cart-subtotal">
                        Subtotal: $ {product.price * (product.quantity || 1)}.00{" "}
                      </Card.Text>
                    </Card.Body>
                  </Card>
                </div>
        ...
        <>
          ...
          <br />
          <br />
          <h2 className="empty-cart" style={{ textAlign: "center" }}>
            Cart is empty
          </h2>
        </>
      )}
